...
const fioContract = new web3.eth.Contract(fioABI, process.env.FIOTOKENETH);
const fioNftContract = new web3.eth.Contract(fioNftABI, process.env.FIONFTETH);
const fioPolygonNftContract = new polyWeb3.eth.Contract(fioPolygonABI, process.env.FIOPOLYGONNFT)
